...
function showLocalnewsList() {
    global $conn;
    $stmt = $conn->prepare("SELECT * FROM local_news ORDER BY id DESC");
    if($stmt->execute()) {
...
<!-- Start showLocalnewsList function. -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container systemLog" id="system_log">
        <div class="row">
            <div class="col-md-12">
                <h4 class="text-center">Local News List</h4>
            </div>
                                ...
                                foreach($result as $row) {
                                    echo "
                                        <tr>
                                            ...
                                            <td>
                                                <form action='localnews_edit.php' method='POST'>
...
} // End of showLocalnewsList function.
?>
